...
# list1 = [1, 2, 3] # принимает итирируемый обьект и возвращает сумму
# print(sum(list1))
...
# list1.sort(reverse=True) # сортирует от большего к меньшему
# print(list1)

# words = ['Hello', 'World'] 
# result = ' '.join(words) функция join 
# print(result)

# num = [1, 3, 2, 4, 5]
# num.reverse() # функция reverse изменяет порядок цифр на обратный - [5, 4, 2, 3, 1]
# print(num)
