...
# print(len(str3)) # функция len - длина строки

str4 = 'asd123'
# print(str4.isalnum())
# print(str4.replace('asd', 'hello')) # str.replace(шаблон, замена, [maxcount]) - maxcount ограничивает число замен

str5 = 'hello world 2222'
...
# print(str5.split()) # разделяет строку на несколько частей и создает список из элементов строки(пробел по умолчанию)
## str.split(sep=None, maxsplit=--1) 
# sep - разделитель, по которому разбивается строка. По дефолту и при указании None будут считаться любые
# пробельные символы(пробел, перевод строки(\n), табуляция(\t))
# str = 'bear, pig, bird, rabbit, horse'
# print(str.split(',')) # разделитель(можно использовать друшие символы как: * , . и тд)
# # если разделитель встречается несколько раз то создает пустые строки

#maxsplit - параметр, который определяет максимальное кол-во разбиений. По умолчанию(или если указано -1)
# строка разбивается полностью на все возмодные подстроки
...
# [start:end:step] !!!для себя запомнить # по индексу(начало, конец, шаг)
